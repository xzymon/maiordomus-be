...
public interface StructureMapper {
	...
	@Mapping(target = "tags", expression = "java(com.xzymon.maiordomus.mapper.helper.MappingHelper.mapFromStringToList(note.getTags()))")
	...
	@Mapping(target = "updatedAt", source = "updatedAt")
	@Mapping(target = "timeReference", source = "timeReference")
	@Mapping(target = "tags", expression = "java(com.xzymon.maiordomus.mapper.helper.MappingHelper.mapFromListToString(dto.getTags()))")
	@Mapping(target = "source", source = "source")
	@Mapping(target = "additionalInfo", source = "additionalInfo")
	@Mapping(target = "authorName", source = "authorName")
