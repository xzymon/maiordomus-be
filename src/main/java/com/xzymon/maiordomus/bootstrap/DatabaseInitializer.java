...
@Component
@ConditionalOnProperty(name = "maiordomus.database.init", havingValue = "true")
public class DatabaseInitializer {
	...
	public DatabaseInitializer(DummyService dummyService,
							   DailyStockCandleRepository dailyStockCandleRepository,
	                           QuarterStockCandleRepository quarterStockCandleRepository,
	...
	public void initializeDatabase() {
		...
		initQuarterStockRepo();
		initDailyStockRepo();
		initNoteRepo();
		System.out.println("Database initialization completed.");
	}

	public void initDailyStockRepo() {
		...
		dsCandles.add(new StooqDailyStockCandle(usdgbp, LocalDate.of(1900,3,01),"0","0.2047","0.2047","0.2047","0.2047"));
		dsCandles.add(new StooqDailyStockCandle(usdgbp, LocalDate.of(1900,6,01),"0","0.2047","0.2047","0.2043","0.2043"));
		dsCandles.add(new StooqDailyStockCandle(usdgbp, LocalDate.of(1900,9,01),"0","0.2043","0.2062","0.2043","0.2062"));
		dsCandles.add(new StooqDailyStockCandle(usdgbp, LocalDate.of(1900,12,01),"0","0.2062","0.2062","0.2058","0.2058"));
		dsCandles.add(new StooqDailyStockCandle(usdgbp, LocalDate.of(1901,3,01),"0","0.2058","0.2058","0.2056","0.2056"));
		dsCandles.add(new StooqDailyStockCandle(usdgbp, LocalDate.of(1901,6,01),"0","0.2056","0.2058","0.2056","0.2058"));
		dsCandles.add(new StooqDailyStockCandle(usdgbp, LocalDate.of(1901,9,01),"0","0.2058","0.2058","0.2043","0.2043"));
		dailyStockCandleRepository.saveAll(dsCandles);
	}

	public void initQuarterStockRepo() {
		List<StockValor> stockValors = new ArrayList<>();
	...
	public void initNoteRepo() {
		Note septemberNote = new Note();
		septemberNote.setTitle("Test Note");
		septemberNote.setContent("First good note!");
		septemberNote.setCategory(NoteCategory.CFD_TRADES);
		septemberNote.setTimeReference(LocalDateTime.of(2024, 9, 30, 14, 24, 15));
		septemberNote.setTags("JPY|USD");

		// Zapis do bazy danych
		Note savedSeptNote = noteRepository.save(septemberNote);

		Note octoberNote = new Note();
		octoberNote.setTitle("Test Note");
		octoberNote.setContent("Second note");
		octoberNote.setCategory(NoteCategory.CFD_TRADES);
		octoberNote.setTimeReference(LocalDateTime.of(2024, 10, 1, 14, 24, 15));
		octoberNote.setTags("JPY|USD");

		// Zapis do bazy danych
		Note savedOctNote = noteRepository.save(octoberNote);
	}
}
